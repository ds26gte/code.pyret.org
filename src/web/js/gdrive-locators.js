define(["q", "js/secure-loader", "js/runtime-util"], function(q, loader, util) {
  function makeLocatorConstructors(storageAPI, runtime, compileLib, compileStructs, spyretParse, replSupport) {
    console.log('doing makeLocatorConstructors');
    var gf = runtime.getField;
    var gmf = function(m, f) { return gf(gf(m, "values"), f); };
    function fileRequestFailure(failure, filename) {
      console.log('doing fileRequestFailure');
